...
<nav class="navbar navbar-expand-lg navbar-light px-3 bg-dark Skorial_Abel text-white">
  ...
  <div class="collapse navbar-collapse" id="navbarResponsive">
    <div class="d-flex flex-column flex-md-row w-100 justify-content-between">
      ...
      <li class="nav-item">
            <a class="nav-link active navbar-paginas text-light" aria-current="page" href= "<?php echo base_url('nosotros');?>">Nosotros</a>
         </li>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link navbar-paginas text-light" href="<?php echo base_url('contacto');?>"> Contacto</a>
          </li>
          <li class="nav-item">
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link navbar-paginas text-light" href="#"><i class="fas fa-user"></i> Mi cuenta</a>
        </li>
        <li class="nav-item">
